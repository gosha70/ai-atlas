 ...
 *
 * <ul>
 *   <li>{@link ai.atlas.annotations.AgentVisibleClass} — marks an entity class
 ...
 *   <li>{@link ai.atlas.annotations.AgentVisible} — marks individual fields for
 *       inclusion in the generated DTO, with attributes for description, display
 *       name, sensitivity, and allowed values.</li>
 *   <li>{@link ai.atlas.annotations.AgenticExposed} — marks a service class or
