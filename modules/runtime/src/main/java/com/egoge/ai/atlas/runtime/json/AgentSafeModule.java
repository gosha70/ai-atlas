 ...
 * <ul>
 *   <li>{@code ai.atlas.json.enriched} — enriched JSON with descriptions/validValues (default: false)</li>
 *   <li>{@code ai.atlas.json.include-descriptions} — include field descriptions (default: true)</li>
 *   <li>{@code ai.atlas.json.include-valid-values} — include enum valid values (default: true)</li>
 * </ul>
 */
public class AgentSafeModule extends Module {
    ...
    public String getModuleName() {
        return "ai-atlas-agent-safe";
    }

    @Override
    public Version version() {
        return new Version(0, 1, 0, "SNAPSHOT", "com.egoge", "ai-atlas-runtime");
    }
