...
public final class HibernateSupport {
    ...
    static {
        ...
        try {
            ...
            available = true;
            LOG.debug("[ai-atlas] Hibernate detected on classpath — proxy unwrapping enabled");
        } catch (ClassNotFoundException | NoSuchMethodException e) {
            LOG.debug("[ai-atlas] Hibernate not on classpath — proxy unwrapping disabled");
        }
    ...
    public static Object unproxy(Object entity) {
        ...
        try {
            ...
            LOG.warn("[ai-atlas] Failed to unproxy entity: {}", e.getMessage());
        }
        return entity;
    }
    ...
    public static boolean isInitialized(Object obj) {
        ...
        try {
            ...
            LOG.warn("[ai-atlas] Failed to check initialization: {}", e.getMessage());
            return true;
        }
    }
    ...
    public static boolean isCollectionInitialized(Object collection) {
        ...
        try {
            ...
            LOG.warn("[ai-atlas] Failed to check collection initialization: {}", e.getMessage());
            return true;
        }
    }
    ...
    public static Object safeResolve(Object value) {
        ...
        if (isPersistentCollection(value)) {
            if (!isCollectionInitialized(value)) {
                LOG.debug("[ai-atlas] Skipping uninitialized collection");
                return null;
            }
        ...
        if (isProxy(value)) {
            if (!isInitialized(value)) {
                LOG.debug("[ai-atlas] Skipping uninitialized proxy");
                return null;
            }
