...
public record ProductView(Long id, String name, Double cost, String legacyCode, Status status,
    ...
    Map.entry("legacyCode", new FieldMeta("Legacy code", List.of(), false, true, false, "")),
    Map.entry("status", new FieldMeta("Lifecycle status", List.of("ACTIVE", "RETIRED"), false, true, false, "")),
