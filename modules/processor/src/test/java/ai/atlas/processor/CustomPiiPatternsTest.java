...
/**
 * Tests for configurable PII patterns via the {@code -Aai.atlas.pii.patterns} option.
 */
class CustomPiiPatternsTest {
    ...
    void detectsCustomPiiPattern() {
        ...
        Compilation compilation = javac()
                ...
                .withOptions("-Aai.atlas.pii.patterns=salary,homeAddress")
                .compile(source);
    ...
    void customPatternsAddToDefaults() {
        ...
        Compilation compilation = javac()
                .withProcessors(new AgenticProcessor())
                .withOptions("-Aai.atlas.pii.patterns=phoneNumber")
                .compile(source);
