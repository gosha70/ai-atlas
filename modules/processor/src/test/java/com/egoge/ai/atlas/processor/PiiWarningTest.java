...
class PiiWarningTest {
    ...
    void noWarningForNonPiiFields() {
        ...
        // Should not contain PII warnings — only generation notes (DTO + OpenAPI versioned + OpenAPI alias + api-version.properties + deprecation-manifest.json) and the no-baseline note
